...
#
# Generated by export_simulation on Mon Dec 13 15:25:35 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './hcc.sh' script.
...
./hcc.sh -noclean_files

For more information on the script, please type './hcc.sh -help'.
